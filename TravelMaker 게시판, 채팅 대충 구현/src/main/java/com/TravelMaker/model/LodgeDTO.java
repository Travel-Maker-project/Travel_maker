...
public class LodgeDTO {
	...
	public void setLodge_ckReservation(String lodge_ckReservation) {
		Lodge_ckReservation = lodge_ckReservation;
	}
	...
	public String getLodge_encodingimgname() {
		return Lodge_encodingimgname;
	}
	public void setLodge_encodingimgname(String lodge_encodingimgname) {
		Lodge_encodingimgname = lodge_encodingimgname;
	}
	...
	public void setLodge_isdeleted(String lodge_isdeleted) {
		Lodge_isdeleted = lodge_isdeleted;
	}
