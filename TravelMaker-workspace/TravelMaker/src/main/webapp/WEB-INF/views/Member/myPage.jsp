 ...
 <div id="mypage" class="flex_center">
        <div class="profile flex_center">
            ...
            <div class="profile_main">
                <div id="profile_img" class="flex_center" style="background-image: url(dtProfile.jfif);">
    ...
    <dialog id="profile_modify">
        <form method="post" class="flex_center" autocomplete="off">
            ...
            <div id="profile_img_modify" class="flex_center" style="background-image: url(dtProfile.jfif);">
                <!-- url(${TRAVELMAKER_MEMBER_ENCODINGPROFILEIMG}) -->
            </div>
            <div class="join_items">
                <span>닉네임</span>
    ...
    <script>
        ...
        function changeHandler(event) {
            ...
            if(event.target.files && event.target.files[0]) {
                ...
                reader.onload = (e) => {
                    profileImgModify.style.backgroundImage = `url('${e.target.result}')`
                }
