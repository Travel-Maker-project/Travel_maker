    ...
    <div class="findEmail">
        ...
        <form method="POST">
            <div class="mailForm">
                ...
                <input type="email" id="email" class="fineMemberEmailForm" name="travelMaker_Member_Email" placeholder="이메일 주소">
            </div>
            <div id="certification">
                <input type="number" class="inputCertification"  placeholder="인증번호">
